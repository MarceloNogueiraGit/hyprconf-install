...
# hyprconf repo url
url="https://github.com/MarceloNogueiraGit/hyprconf-v2/archive/refs/heads/main.zip"
...
#     git clone --depth=1 https://github.com/MarceloNogueiraGit/hyprconf-v2.git "$parent_dir/.cache/hyprconf-v2" 2>&1 | tee -a "$log" &> /dev/null
# fi
# ---------------------- old ---------------------- #
