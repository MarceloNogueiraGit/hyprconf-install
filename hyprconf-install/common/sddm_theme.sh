...
url="https://github.com/MarceloNogueiraGit/SilentSDDM/archive/refs/heads/main.zip"
...
# git clone --depth=1 https://github.com/MarceloNogueiraGit/SilentSDDM.git "$parent_dir/.cache/SilentSDDM" &> /dev/null
