...
# hyprconf repo url
url="https://github.com/MarceloNogueiraGit/hyprconf/archive/refs/heads/main.zip"
...
#     git clone --depth=1 https://github.com/MarceloNogueiraGiMarceloNogueiraGit/hyprconf.git "$parent_dir/.cache/hyprconf" 2>&1 | tee -a "$log" &> /dev/null
# fi
# ---------------------- old ---------------------- #
